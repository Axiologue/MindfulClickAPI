...
var ArticleWrapper = React.createClass ({displayName: "ArticleWrapper",
  ...
  render: function() {
    var buttons = ['cross','edit','delete'].map(function (key) {
...
var WarningModal = React.createClass ({displayName: "WarningModal",
  render: function() {
    return (
      React.createElement("div", {className: "modal fade", tabindex: "-1", role: "dialog", "aria-labelledby": "myModalLabel" + this.props.id}, 
        React.createElement("div", {class: "modal-dialog", role: "document"}, 
          React.createElement("div", {class: "modal-content"}, 
            React.createElement("div", {class: "modal-header"}, 
              ...
              React.createElement("h4", {class: "modal-title", id: "myModalLabel" + this.props.id}, this.props.title)
            ), 
            ...
            React.createElement("div", {class: "modal-footer"}, 
              ...
              React.createElement("button", {type: "button", class: "btn btn-primary", onClick: this.props.action}, "Save changes")
            )
          )
        )
      )
