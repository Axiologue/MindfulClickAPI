    ...
    return (
        React.createElement("div", {className: "col-xs-12 listitem"}, 
          ...
          React.createElement("form", {method: "post", onSubmit: this.handleSubmit}, 
            ...
            React.createElement(TextFormElement, {element: "title", id: this.props.id, value: this.props.title, ref: "title"}), 

            React.createElement(TextFormElement, {element: "url", id: this.props.id, value: this.props.url, ref: "url"}), 
