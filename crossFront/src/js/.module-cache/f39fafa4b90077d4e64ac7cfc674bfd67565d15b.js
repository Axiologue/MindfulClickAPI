    ...
    if (!this.state.add_analysis && !this.state.edit) {
      var normalView = (
          React.createElement("div", {className: "article listitem col-xs-12"}, 
            ...
            React.createElement(WarningModal, {message: 'Are you sure you want to delete the article "' + this.state.title + '"? This will not only remove the article, but any associated analysis that has done before.  This cannot be undone.', 
              id: this.props.id, 
