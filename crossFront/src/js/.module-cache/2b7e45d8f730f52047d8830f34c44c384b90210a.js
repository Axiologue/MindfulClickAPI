    ...
    return (
        React.createElement("div", {className: "col-xs-12 listitem"}, 
          ...
          React.createElement("form", {method: "post", onSubmit: this.handleSubmit}, 
            ...
            React.createElement(TextFormElement, {element: "title", type: "text", id: this.props.id, value: this.props.title, ref: "title"}), 

            React.createElement(TextFormElement, {element: "url", type: "text", id: this.props.id, value: this.props.url, ref: "url"}), 

            React.createElement(TextAreaFormElement, {element: "notes", id: this.props.id, value: this.props.notes, ref: "notes"}), 
...
var TextInputElement = React.createClass ({displayName: "TextInputElement",
  getInitialState: function() {
    return {
