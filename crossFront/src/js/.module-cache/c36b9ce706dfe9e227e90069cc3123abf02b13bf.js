...
var CrossWrapper = React.createClass ({displayName: "CrossWrapper",
  ...
  addCross: function(data) {
    ...
    data.subcategory = $.grep(subFlatten,function(v) {return v.id === data.subcategory})[0];
    var temp = [data];
    this.setState(
    ...
    return (
        React.createElement("div", {className: "col-xs-12 listitem"}, 
          ...
          React.createElement("form", {method: "post", onSubmit: this.handleSubmit}, 
            ...
            React.createElement(FormHiddenElement, {name: "article", value: this.props.article_id, ref: "article"}), 
