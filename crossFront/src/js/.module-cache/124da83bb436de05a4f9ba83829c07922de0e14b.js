    ...
    return (
        React.createElement("div", {className: "col-xs-12 listitem"}, 
          ...
          React.createElement("form", {method: "post", onSubmit: this.handleSubmit}, 
            ...
            React.createElement(TextFormElement, {element: "title", id: this.props.id}), 

            React.createElement(TextFormElement, {element: "url", id: this.props.id}), 

            React.createElement(TextAreaFormElement, {element: "notes", id: this.props.ied}), 
...
var TextFormElement = react.createClass ({
  render: function() {
    ...
    return (
      React.createElement("div", {className: "form-group"}, 
        ...
        React.createElement("input", {type: "text", name: this.props.element, id: elID, className: "form-control", ref: this.props.element})
      )
    );
  }
});

var TextAreaFormElement = react.createClass ({
  render: function() {
    var elID = this.props.element + this.props.id;
    ...
    return (
      React.createElement("div", {className: "form-group"}, 
        React.createElement("label", {for: elID}, this.props.element.toUpperCase(), ":"), 
        React.createElement("textArea", {rows: 3, name: this.props.element, id: elID, className: "form-control", ref: this.props.element})
      )
    );
  }
});
