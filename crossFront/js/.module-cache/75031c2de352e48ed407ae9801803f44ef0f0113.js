...
var ArticleForm = React.createClass ({displayName: "ArticleForm",
  handleSubmit: function(e) {
    ...
    Object.keys(this.props).forEach(function (element, index, array) {
      if(element != 'submitLink' && element != 'error') {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // Add success message
        this.props.success = 'Your article has been successfully added!'
  ...
  render: function() {
    ...
    var Msg = function() {
      if(this.props.error) {
        return (
            React.createElement("h3", {className: "text-danger"}, this.props.error)
          );
      }
      if(this.props.success) {
        return (
            React.createElement("h3", {className: "text-success"}, this.props.success)
          );
      }
    }
