from refData.models import Article, Product, EthicsSubCategory, Company, Factoid
from refData.serializers import ArticleSerializer, ProductSerializer, \
        EthicsSubSerializer, CompanySerializer
...
class ArticleNoCrossView(generics.ListAPIView):
    queryset = Article.objects.annotate(c=Count('factoids')).filter(c=0)
